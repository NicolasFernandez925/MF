...
export const Data = () => {
  ...
  return (
    <div className="packs-card packs-card--grid">
      <div>
        <Drawer
          id="drawer"
          divide
        ...
        <p className="body-2-bold packs-card__title">Datos</p>
        <Table<any>
          headers={headers}
          bordered
          footer={<Footer />}
      ...
      <div className="packs-card__daily-consumption packs-card__daily-consumption--ml">
        <p className="body-2-bold packs-card__title">Consumo diario</p>
        <DailyConsumption handleOpen={handleOpen} />
      </div>
    </div>
  );
};
